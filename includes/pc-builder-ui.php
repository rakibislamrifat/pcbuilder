                ...
                <div class="pcbuild-scroll-wrapper">
                    <div class="cardWarpper">
                        ...
                        <div class="row">
                            <div class="comp card">
                                <a href="javascript:void(0)" class="pc-part"
                                    data-redirect="<?php echo site_url('/products/cpu'); ?>">
                        ...
                        <div class="row">
                            <div class="comp card">
                                <a href="javascript:void(0)" class="pc-part"
                                    data-redirect="<?php echo site_url('/products/cpu-cooler'); ?>">
                        ...
                        <div class="row">
                            <div class="comp card">
                                <a href="javascript:void(0)" class="pc-part"
                                    data-redirect="<?php echo site_url('/products/motherboard'); ?>">
                        ...
                        <div class="row">
                            <div class="comp card">
                                <a href="javascript:void(0)" class="pc-part"
                                    data-redirect="<?php echo site_url('/products/memory'); ?>">
                        ...
                        <div class="row">
                            <div class="comp card">
                                <a href="javascript:void(0)" class="pc-part"
                                    data-redirect="<?php echo site_url('/products/storage'); ?>">
                        ...
                        <div class="row">
                            <div class="comp card">
                                <a href="javascript:void(0)" class="pc-part"
                                    data-redirect="<?php echo site_url('/products/video-card'); ?>">
                        ...
                        <div class="row">
                            <div class="comp card">
                                <a href="javascript:void(0)" class="pc-part"
                                    data-redirect="<?php echo site_url('/products/case'); ?>">
                        ...
                        <div class="row">
                            <div class="comp card">
                                <a href="javascript:void(0)" class="pc-part"
                                    data-redirect="<?php echo site_url('/products/power-supply'); ?>">
                        ...
                        <div class="row">
                            <div class="comp card">
                                <a href="javascript:void(0)" class="pc-part"
                                    data-redirect="<?php echo site_url('/products/operating-system'); ?>">
                        ...
                        <div class="row">
                            <div class="comp card">
                                <a href="javascript:void(0)" class="pc-part"
                                    data-redirect="<?php echo site_url('/products/monitor'); ?>">
                        ...
                        <div class="row">
                            <div class="comp card">
                                <a href="javascript:void(0)" class="pc-part"
                                    data-redirect="<?php echo site_url('/products/sound-card'); ?>">
                        ...
                        <!-- Wired Network Adapter selection row showing pricing, availability, and purchase options -->
                        <div class="row">
                            <div class="comp card">
                                <a href="javascript:void(0)" class="pc-part"
...
document.addEventListener("DOMContentLoaded", function() {
        ...
        partTriggers.forEach(trigger => {
            trigger.addEventListener("click", function() {
                ...
                fetch(pcbuild_ajax_object.ajax_url, {
                        ...
                        body: 'action=load_pcbuild_parts&category=' + encodeURIComponent(
                            category)
                    })
    ...
    function updateRow(category, data) {
        ...
        rows.forEach(row => {
            const categorySpan = row.querySelector(".componentName");
            if (categorySpan && categorySpan.textContent.trim().toLowerCase() === category
                .toLowerCase()) {
		...
		`;
            ...
            <div class="product-selected" style="display: flex; align-items: center; gap: 12px;">
              ...
              <div style="flex: 1;"><strong style="font-size: 14px; display: block;">${escapedTitle}</strong></div>
                    ...
                    if (row.querySelector(".shipping")) row.querySelector(".shipping").textContent =
                        shipping;
                    if (row.querySelector(".availability")) row.querySelector(".availability")
...
function showProductDetails(category) {
    ...
    detailsWrapper.innerHTML = `
      ...
      ">
        ...
        tr style = "border-bottom: 1px solid #f5f5f5;" >
        <
        td style = "padding: 6px 10px; font-weight: 600; color: #444; width: 160px;" > $ {
            formattedKey
        } < /td> <
